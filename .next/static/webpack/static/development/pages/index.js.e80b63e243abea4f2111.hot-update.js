...
function (_Component) {
  ...
  function App(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "onRemove", function (event) {// this.state.items.map((item, index) => ( 
      //   // console.log(this.state.items.event),
      // // console.log(this.state.items[index]),
      // // console.log(this.state.items),
      // // // console.log(event.target),
      // //   console.log(event)
      // // this.state.items.map((item,index) => console(map)
      // )
      // )
    });
...
//# sourceMappingURL=index.js.e80b63e243abea4f2111.hot-update.js.map