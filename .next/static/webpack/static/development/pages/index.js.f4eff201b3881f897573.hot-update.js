...
function (_Component) {
  ...
  function App(props) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_7__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_5__["default"])(_this), "onRemove", function (event) {
      _this.setState({
        items: _this.state.items.filter(_this.state.item, _this.state.items[index], _this.state.items)
      });

      console.log(_this.state.items), console.log(items);
    });
...
//# sourceMappingURL=index.js.f4eff201b3881f897573.hot-update.js.map